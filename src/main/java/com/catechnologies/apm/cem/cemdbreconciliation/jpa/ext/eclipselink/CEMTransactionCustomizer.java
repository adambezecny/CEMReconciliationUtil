 ...
 *
 */
public class CEMTransactionCustomizer implements DescriptorCustomizer {

	@Override
	public void customize(ClassDescriptor descriptor) throws Exception {

		
		OneToManyMapping mapping1 = (OneToManyMapping) descriptor.getMappingForAttributeName("tsTrancomps");
		...
		Expression fkExp1 = eb1.getField("ts_trancomps.ts_tranunit_id").equal(eb1.getParameter("ts_tranunits.ts_id"));
		Expression softDeleteExp1 = eb1.getField("ts_trancomps.ts_soft_delete").equal(false);
		
		Expression fkExp2 = eb2.getField("ts_defect_defs.ts_tranunit_id").equal(eb2.getParameter("ts_tranunits.ts_id"));
		...
		mapping2.setSelectionCriteria(fkExp2.and(softDeleteExp2).and(tranCompIdExp2));
